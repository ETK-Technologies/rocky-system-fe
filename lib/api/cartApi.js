 ...
 * @param {string} origin - Origin header value (optional)
 * @returns {Promise<Object|null>} Cart data or null if not found
 */
export async function fetchCartFromBackend(authToken = null, sessionId = null, origin = null) {
  try {
    ...
    // Add Origin header if provided (required for backend domain whitelist)
    if (origin) {
