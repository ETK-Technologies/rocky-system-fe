  ...
  const extractAnswer = (answer) => {
    ...
    if (Array.isArray(answer)) {
      ...
      if (answer.value?.value?.value?.answer) {
        console.log(
          "🔑🔑🔑 Found answer.value.value.value.answer (triple nested):",
      ...
      // Check for double-nested value.value.answer structure
        ...
        console.log(
          "🔑🔑 Found answer.value.value.answer (double nested):",
                ...
                <div className="flex items-center gap-4">
                  ...
                  {option.hasImage && option.image && (
                    <div
                      ...
                      onMouseLeave={() =>
                        setZoomState({ show: false, image: null, x: 0, y: 0 })
                      }
                    >
                      <img
                        src={option.image}
                  ...
                  {option.hasTooltip && option.tooltip && (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center hover:bg-gray-300 transition-colors cursor-help">
              ...
              {isSelected && option.hasTextarea && (
                <div className="mt-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleTextareaChange(option.text, e.target.value)
                    }
