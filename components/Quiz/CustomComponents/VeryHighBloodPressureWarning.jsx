...
export default function VeryHighBloodPressureWarning({
  step,
  answer,
  onAnswerChange,
  onBack,
    ...
    >
      ...
      <div className="flex-1 flex flex-col overflow-y-auto pb-[80px] md:pb-[100px]">
        <div className="w-full md:w-[520px] max-w-xl mx-auto px-5 md:px-0 py-4 relative flex flex-col">
          ...
          >
            This is considered very high and we would not be able to provide you with a prescription today. We strongly advise you seek immediate medical attention.
          </p>
        </div>
      </div>
